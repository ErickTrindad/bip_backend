...
import {
  groqTranscribeBodySchema,
  groqPromptBodySchema,
  groqVoiceCommandBodySchema,
  groqTranscribeResponseSchema,
  groqPromptResponseSchema,
  ...
  typedApp.post(
    '/ai/transcribe',
    {
      ...
      schema: {
        ...
        description:
          'Envia áudio codificado em base64 para o modelo Whisper Large v3 na Groq Cloud. Otimizado para português brasileiro com ruído ambiente de mercado/varejo.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.post(
    '/ai/transcribe/upload',
    {
      ...
      schema: {
        ...
        description:
          'Envia arquivo de áudio direto do microfone do navegador/celular via multipart/form-data para transcrição imediata.',
        security: [{ bearerAuth: [] }],
        response: {
          200: groqTranscribeResponseSchema,
  ...
  typedApp.post(
    '/ai/chat',
    {
      ...
      schema: {
        ...
        description:
          'Executa prompt no modelo Llama em hardware Groq (LPU) com fallback automático em cascata. Suporta modo JSON estruturado.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.post(
    '/ai/voice-command',
    {
      ...
      schema: {
        ...
        description:
          'Pipeline inteligente para repositores e caixas: transcreve a fala do operador com Whisper Large v3, extrai a intenção estruturada com Llama e opcionalmente executa movimentações de estoque ou vendas automaticamente.',
        security: [{ bearerAuth: [] }],
