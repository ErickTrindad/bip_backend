...
import {
  ...
  spaceOptimizationReportResponseSchema,
  executiveOverviewResponseSchema,
...
export const reportRoutes: FastifyPluginAsync = async (app: FastifyInstance) => {
  ...
  typedApp.get(
    '/reports/overview',
    {
      ...
      schema: {
        ...
        description:
          'Retorna visão executiva do estoque, valor total do catálogo a preço de venda e custo, margem média consolidada, saúde do giro e alertas rápidos de compras.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/reports/abc',
    {
      ...
      schema: {
        ...
        description:
          'Classificação analítica dos produtos em Classes A (80% da receita), B (15%) e C (5%) baseada no Princípio de Pareto, com indicadores de velocidade de saída, margem unitária e dias de autonomia de estoque.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/reports/turnover-margin-matrix',
    {
      preHandler: [authMiddleware],
      schema: {
        tags: ['Relatórios'],
        ...
        description:
          'Matriz 2x2 que segmenta produtos em 4 quadrantes: Estrelas (Alto Giro + Alta Margem), Geradores de Tráfego (Alto Giro + Baixa Margem), Oportunidades de Rentabilidade (Baixo Giro + Alta Margem) e Candidatos à Descontinuação (Baixo Giro + Baixa Margem).',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/reports/replenishment-purchasing',
    {
      preHandler: [authMiddleware],
      schema: {
        tags: ['Relatórios'],
        ...
        description:
          'Calcula o Ponto de Pedido (Lead Time + Estoque de Segurança) e sugere lotes de compra ideais para prevenir ruptura e otimizar o capital de giro.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/reports/space-optimization',
    {
      ...
      schema: {
        ...
        description:
          'Avalia a eficiência do espaço alocado na gôndola em relação ao faturamento gerado e recomenda ações: Expandir Facings, Manter, Reduzir ou Reavaliar Mix.',
        security: [{ bearerAuth: [] }],
