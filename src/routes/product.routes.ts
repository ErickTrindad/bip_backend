  ...
  typedApp.get(
    '/products/lookup/:barcode',
    {
      ...
      schema: {
        ...
        description:
          'Consulta o banco de dados mundial Open Food Facts para autocompletar nome, categoria, marca e imagem ao escanear código de barras EAN.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/products/critical',
    {
      ...
      schema: {
        ...
        description:
          'Retorna produtos onde a quantidade na gôndola (shelfQty) está abaixo ou igual ao mínimo de segurança (shelfMinQty), ordenados por percentual de urgência e déficit.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.post(
    '/products/pos/sale',
    {
      ...
      schema: {
        ...
        description:
          'Permite registrar a venda de múltiplos itens com baixa automática do estoque da gôndola (shelf_qty) e seleção da forma de pagamento.',
        security: [{ bearerAuth: [] }],
        body: posSaleSchema,
        response: {
  ...
  typedApp.get(
    '/products/barcode/:barcode',
    {
      ...
      schema: {
        ...
        description:
          'Busca rápida de produto no estoque da empresa pelo código de barras escaneado (EAN/GTIN).',
        security: [{ bearerAuth: [] }],
        params: productBarcodeParamsSchema,
        querystring: z.object({
          tenantId: z.string().uuid().optional().describe('Filtrar por tenant (Super Admin apenas)'),
  ...
  typedApp.post(
    '/products/:id/transfer',
    {
      ...
      schema: {
        ...
        description:
          'Executa operação atômica de reposição: subtrai X unidades de depot_qty e adiciona X unidades a shelf_qty.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.get(
    '/products',
    {
      ...
      schema: {
        ...
        description:
          'Retorna lista paginada de produtos do tenant autenticado, com suporte a busca textual por nome ou código de barras e filtro por categoria.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.post(
    '/products',
    {
      ...
      schema: {
        ...
        description:
          'Cadastra um novo produto no tenant com quantidades de depósito, gôndola, estoque mínimo e preço. Valida limite de 100 SKUs no plano Free.',
        security: [{ bearerAuth: [] }],
  ...
  typedApp.put(
    '/products/:id',
    {
      ...
      schema: {
        ...
        description:
          'Atualiza informações cadastrais, estoques ou localizações de um produto existente.',
        security: [{ bearerAuth: [] }],
        params: productParamsSchema,
  ...
  typedApp.delete(
    '/products/:id',
    {
      ...
      schema: {
        ...
        description:
          'Remove definitivamente um produto do catálogo da empresa.',
        security: [{ bearerAuth: [] }],
        params: productParamsSchema,
        response: {
