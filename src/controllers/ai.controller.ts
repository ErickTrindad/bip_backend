...
export class AiController {
   ...
   */
  async listModels(_request: FastifyRequest, reply: FastifyReply) {
    try {
   ...
   */
  async transcribeFile(request: FastifyRequest, reply: FastifyReply) {
    try {
   ...
   */
  async chatPrompt(request: FastifyRequest, reply: FastifyReply) {
   ...
   */
  async voiceCommand(request: FastifyRequest, reply: FastifyReply) {
