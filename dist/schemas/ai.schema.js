...
export const actionItemResponseSchema = z.object({
    ...
    matchedProduct: z
        ...
        depotQty: z.number().int().describe('Quantidade inteira no depósito'),
        shelfQty: z.number().int().describe('Quantidade inteira na gôndola'),
    })
        .nullable()
        .optional(),
    price: z.number().nullable().optional(),
    quantity: z.number().int().positive().nullable().optional().describe('Quantidade inteira positiva'),
    depotQty: z.number().int().min(0).nullable().optional(),
    shelfQty: z.number().int().min(0).nullable().optional(),
