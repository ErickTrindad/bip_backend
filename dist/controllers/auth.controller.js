...
import { registerSchema, superAdminRegisterSchema, loginSchema, forgotPasswordSchema, resetPasswordOtpSchema, } from '../schemas/auth.schema.js';
export class AuthController {
    ...
    async registerSuperAdmin(request, reply) {
    ...
    async resetPasswordWithOtp(request, reply) {
