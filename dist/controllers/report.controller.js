...
import { abcReportQuerySchema, matrixReportQuerySchema, replenishmentReportQuerySchema, spaceOptimizationReportQuerySchema, } from '../schemas/report.schema.js';
export class ReportController {
     ...
     */
    async getAbcReport(request, reply) {
        const user = request.user;
     ...
     */
    async getMatrixReport(request, reply) {
        const user = request.user;
     ...
     */
    async getReplenishmentReport(request, reply) {
        const user = request.user;
     ...
     */
    async getSpaceOptimizationReport(request, reply) {
        const user = request.user;
